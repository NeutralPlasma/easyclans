...
import eu.virtusdevelops.easyclans.gui.ui.MembersMenu;
...
public class ClanMembersCommand implements AbstractCommand {
    ...
    @Permission("easyclans.command.members")
    ...
    public void clanBankCommand(
        ...
        new MembersMenu(
                player,
                clan,
                plugin.getClansController(),
                plugin.getPlayerController(),
                plugin.getCurrenciesController(),
                plugin.getRequestsController(),
                plugin.getInvitesController(),
                plugin.getLogController(),
                plugin.getRanksController(),
                plugin,
                null
        );
